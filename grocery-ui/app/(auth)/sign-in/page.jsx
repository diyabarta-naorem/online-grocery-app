  ...
  return (
    <div className="flex items-baseline justify-center my-10 ">
      ...
      >
        ...
        <h2 className="text-gray-500">Enter your Email and Password to Login into your account
        </h2>
        <div className="w-full flex flex-col gap-5 mt-7">
            ...
            <p>Don't have an account?
                <Link href={'/create-account'} className="text-blue-500 italic"> Click here to Create an account</Link>
            </p>
        </div>
      </div>
    </div>
